<?php
  $this->title = 'Privilege';
   ...
   $this->registerCssFile(Yii::$app->request->baseUrl.'/css/lib/datepicker/bootstrap-datepicker3.min.css', ['depends' => [\backend\assets\MainAsset::className()]]);
    ...
    $this->registerJsFile(Yii::$app->request->baseUrl.'/js/angular/modules/privilege/default.js', ['depends' => [\backend\assets\AngularAsset::className()]]);
?>
<div class="row">
	<div class="card card-outline-info col-md-12" ng-controller="privilegeController" ng-init="init('<?=Yii::$app->request->baseUrl?>');">     
		<div class="card-body ">
