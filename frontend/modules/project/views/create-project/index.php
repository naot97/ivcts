<?php
    ...
    $this->registerJsFile('/ivcts'.'/js/modules/project/create-project-ready.js', ['depends' => [\frontend\assets\MainAsset::className()]]);
    $this->registerJsFile('/ivcts'.'/js/angular/modules/project/create-project-controllers.js', ['depends' => [\frontend\assets\AngularAsset::className()]]);
?>  
<div class="row" ng-controller="createProjectController" ng-init="init('<?=Yii::$app->request->baseUrl?>');">
    <div class="col-12">
                ...
                <div id="tagHistory" class="mega-dropdown">
                    <div class="dropdown-menu animated zoomIn">
                        <ul class="mega-dropdown-menu">
                            <li>
                                <?php 
                                echo $this->render('partials/grid-projects-history'); ?>       
                            </li>
                        </ul>
                    </div>     
                </div>      
                <?php 
                echo $this->render('partials/input-data',['powerWrite' => $powerWrite]); ?>
                                
                <?php echo $this->render('partials/grid-projects'); ?>
            </div>
        </div>
    </div>    
</div>
