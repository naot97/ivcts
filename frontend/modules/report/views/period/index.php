<?php
    ...
    $this->registerJsFile(Yii::$app->request->baseUrl.'/js/angular/modules/report/period.js', ['depends' => [\frontend\assets\AngularAsset::className()]]);
?>
<div class="row" ng-controller="periodController" ng-init="init('<?=Yii::$app->request->baseUrl?>');">
    <div class="col-12">
        <div class="card card-outline-info">            
            <div class="card-body">                     
                   
                <?php echo $this->render('info',['powerWrite'=>$powerWrite]); ?>
